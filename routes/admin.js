...
const { createService, editService, deleteService, getAllServices, getServiceDetails,getServiceBookings} = require("../controller/ServicesController");
...
router.get("/admin/allServiceBookings",authAdmin,getServiceBookings);
